...
namespace lbas_cam 
{
	...
	bool LBASCam::GrabImage(sensor_msgs::msg::Image* msg,sensor_msgs::msg::CameraInfo *cam_msg) 
	{
		int nRet =0;
		...
		if (nRet == MV_OK) 
		{
			...
			cam_msg->header.stamp 		= 	rclcpp::Time(stImageInfo.stFrameInfo.nDevTimeStampHigh, stImageInfo.stFrameInfo.nDevTimeStampLow);					//相机时间
